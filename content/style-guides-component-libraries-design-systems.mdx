...
inside Markdown files. The blog you're reading right now [uses this](https://github.com/leerob/tevanb.com).
...
Feel free to [reach out](mailto:me@tevanb.com) if you wanna chat about building design systems.
