...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
      <loc>https://tevanb.com</loc>
  </url>
  <url>
      <loc>https://tevanb.com/blog</loc>
  </url>
</urlset>
```
...
> **Note:** `globby` [might not work](https://github.com/leerob/tevanb.com/issues/293) on Windows.
    ...
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
        ${pages
          .map((page) => {
            ...
            return `
              <url>
                  <loc>${`https://tevanb.com${route}`}</loc>
              </url>
            `;
          })
          .join('')}
...
```bash
User-agent: *
Sitemap: https://tevanb.com/sitemap.xml
```
